...
export default class MyLinksWebPart extends BaseClientSideWebPart<IMyLinksWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IMyLinksProps> = React.createElement(
      MyLinks,
      {
        MyLinksIdList: this.properties.MyLinksIdList,
        UsersLinksIdList: this.properties.UsersLinksIdList,
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyFieldListPicker("MyLinksIdList", {
                  label: "Select list",
                  selectedList: this.properties.MyLinksIdList,
                  includeHidden: false,
                ...
                PropertyFieldListPicker("UsersLinksIdList", {
                  label: "Select Jobs list",
                  selectedList: this.properties.UsersLinksIdList,
                  includeHidden: false,
                  orderBy: PropertyFieldListPickerOrderBy.Title,
                  disabled: false,
                  onPropertyChange: this.onPropertyPaneFieldChanged.bind(this),
                ...
                PropertyFieldNumber("NumberOflinks", {
                  key: "NumberOflinks",
                  label: "Number Of links",
                  description: "Number Of links",
                  value: this.properties.NumberOflinks,
                  disabled: false
                }),
              ]
            }
